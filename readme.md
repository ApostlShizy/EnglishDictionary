...
- #### Stats
    Класс отвечающий за составление и запись статистики пользователя. А так же запись актуального словаря. Статистика хранится слова, его значения и соотношения правильных и неправильных ответов :
``` json
{
    "abolish": {
    "ratio": 0,
...
- После начала ввода мы видим отображение его в отдельных элементах на экране. Где визуальная подсказка даёт нам понять когда мы ошиблись с выбранными символом а когда ввод был корректный
